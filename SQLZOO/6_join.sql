...
column in the game table. We can look up information about game 1012 by finding
...
table. The ON says how to figure out which rows in game go with which rows
in goal - the id from goal must match matchid from game. (If we wanted to be
more clear/specific we could say
