...
/*
3.
Give the name and the per capita GDP for those countries with a population of
...
For South America show population in millions and GDP in billions both
to 2 decimal places.
*/
...
one trillion (1000000000000; that is 12 zeros).
